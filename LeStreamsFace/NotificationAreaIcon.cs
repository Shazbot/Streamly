...
namespace LeStreamsFace
{
    ...
    public class NotificationAreaIcon : FrameworkElement, IDisposable
    {
        ...
        public void BalloonTip(string tipText, string tipTitle, int duration = 8000, ToolTipIcon toolTipIcon = ToolTipIcon.Info)
        {
            notifyIcon.ShowBalloonTip(duration, tipTitle, tipText, toolTipIcon);
        }
    }
}